...
//    
//    kassapäätteen metodin lataa kutsu lisää matkakortille ladattavan rahamäärän käyttäen
//            kortin metodia lataa jos ladattava summa on positiivinen
//    kassapäätteen metodin lataa kutsu ei tee matkakortille mitään jos ladattava summa on negatiivinen

    @Test
    public void lataaJosSummaPositiivinen() {
    ...
    @Test
    public void eiLataaJosSummaNegatiivinen() {
